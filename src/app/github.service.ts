...
export class GithubService {
  ...
  private _url: string = "https://api.github.com/users/codebr3ak/repos?access_token=" + "535266855deafa4bf251c7086ad7d94a891ec0f2"
  username!: string;
  ...
  getUserProfile() {
    ...
    let promise = new Promise<void>((resolve, reject) => {
      this.http.get<IUser>("https://api.github.com/users/codebr3ak/repos?access_token=" + "535266855deafa4bf251c7086ad7d94a891ec0f2")
        .toPromise()
        .then(data => {
